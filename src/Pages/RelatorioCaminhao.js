...
const TruckDetails = ({ id }) => {
    ...
    const [emissaoPorKm, setEmissaoPorKm] = useState(0); // Emissão por km
    ...
    function FatorCombustivel(combustivel) {
        let fatorEmissao;
        switch (combustivel) {
            case 'diesel':
                fatorEmissao = 2.68;
            ...
            <View style={styles.emissionCard}>
                {error ? (
                    <View style={styles.noDataWrapper}>
                        <Text style={{ fontSize: 15, textAlign: 'center', color: '#FF6859' }}>Sem registro nessa data</Text>
                    </View>
                ) : (
